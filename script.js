...
const roster = {
  Englade: [
          ...
          Russell: ["April L","Zain A","Sebastian A","Madul B","Evolet D","Derick M",
          ...
          Miller: ["Malia A","Rico B","Angel B","Malcolm B","Camden C","Spencer C","Jose O",
          ...
          Massengill: [],
          Clark: ["Angela A","Violet A","Youanna A","Karim O","Joel C","Zenobia D","Gianni F",
...
// stores student answers by index: "a", "b", "c", or "d"
...
// when teacher changes, update student list
...
function initNavigator() {
  console.log("initNavigator called");
...
function renderQuestion() {
  console.log("renderQuestion called for index", currentIndex);
...
if (q.type === "matrix") {
  ...
  const stored = studentAnswers[currentIndex] || {}; // { stmt1: "T", ... }
  ...
  q.statements.forEach(stmt => {
    ...
    trueInput.name = stmt.id;    // one group per row
    trueInput.value = "T";
    if (stored[stmt.id] === "T") trueInput.checked = true;
